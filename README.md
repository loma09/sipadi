...
[![License](https://img.shields.io/badge/License-MIT-2d6a4f)](LICENSE)
...
│
├── tests/                    # (ini penting banget buat naik level)
│
├── docs/                     # diagram, arsitektur, dll
│
├── .env
├── requirements.txt
├── pyproject.toml            # optional (lebih modern)
└── README.md
```
---
