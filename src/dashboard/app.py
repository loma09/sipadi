...
<style>
    ...
    [data-testid="stSidebar"] {
        ...
        border-right: 1px solid var(--green-800) !important;
    }
    ...
    [data-testid="stSidebar"] .stRadio div[role="radiogroup"] label[data-checked="true"] {
        background: linear-gradient(135deg, rgba(45,106,79,0.4), rgba(82,183,136,0.15)) !important;
        border-color: var(--green-300) !important;
        color: var(--green-100) !important;
        font-weight: 600 !important;
        box-shadow: 0 0 12px rgba(82,183,136,0.12);
    }
    /* Hide radio dot indicator for cleaner look */
    [data-testid="stSidebar"] .stRadio div[role="radiogroup"] label > div:first-child {
        display: none !important;
    }
    [data-testid="stSidebarNav"] { display: none; }

    /* ── Style native sidebar controls (don't hide them!) ── */
    [data-testid="stSidebarCollapseButton"] button,
    [data-testid="collapsedControl"] button {
        background: var(--green-950, #071810) !important;
        border: 1px solid #1a3d2a !important;
    ...
    .top-banner {
        ...
        background-image:
            radial-gradient(ellipse at 85% 30%, rgba(52,183,136,0.08) 0%, transparent 60%),
            radial-gradient(ellipse at 10% 80%, rgba(29,80,53,0.15) 0%, transparent 50%);
    ...
    .top-banner-stat:last-child { border-right: none; }
    ...
    .top-banner-stat-value {
        font-size: 0.8rem;
        font-weight: 600;
        color: rgba(255,255,255,0.8);
        display: block;
    }
    .top-banner-stat-highlight .top-banner-stat-value {
        color: var(--green-200);
    }
    ...
    .kpi-card::before {
        ...
        right: 0;
        height: 2px;
        background: var(--kpi-accent, var(--green-300));
    }
    .kpi-card:hover {
    ...
    .delta-up      { background: var(--green-50);  color: #15803d; }
    .delta-down    { background: var(--red-50);     color: var(--red-600); }
    .delta-neutral { background: var(--ink-50);     color: var(--ink-500); }
    ...
    .tag-green { background: var(--green-50); color: #15803d; }
    ...
    .val-red   { color: var(--red-600) !important; }
    ...
    .priority-high   { background: var(--red-50);   color: var(--red-600); }
    .priority-medium { background: var(--amber-50); color: var(--amber-500); }
    .priority-low    { background: var(--green-50); color: #15803d; }
    ...
    .stButton > button {
        ...
        transition: all 0.2s ease !important;
        font-family: 'Sora', sans-serif !important;
        box-shadow: 0 2px 8px rgba(29,80,53,0.25) !important;
    }
    .stButton > button:hover {
        background: linear-gradient(135deg, var(--green-700), var(--green-600)) !important;
        box-shadow: 0 4px 16px rgba(29,80,53,0.35) !important;
    ...
    /* ── Hide Streamlit Defaults (keep header visible for sidebar control!) ── */
